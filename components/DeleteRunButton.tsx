  ...
  return (
    <>
      <button
        ...
        className="opacity-0 group-hover:opacity-100 text-red-400 hover:text-red-300 transition p-1 rounded"
          ...
          >
            ...
            <div className="flex items-center gap-3 pt-2">
              <form ref={formRef} action={deleteRun} className="contents">
                ...
                <button
                  type="submit"
                  className="rounded-xl bg-red-500 text-white font-medium px-5 py-2.5 hover:bg-red-600 transition text-sm"
                >
                  Supprimer
                </button>
              </form>
